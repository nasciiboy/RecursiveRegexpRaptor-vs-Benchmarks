...
void find_all( char *pattern, char *raptorPattern, char *subject, int subject_len ){
  char str[3][1024];
  printf("<tr><td class=\"pattern\"><table><tr><td>%s</td></tr><tr><td class=\"raptorPattern\">%s</td></tr></table></td>", toHTML( pattern, str[0] ), toHTML( raptorPattern, str[1] ));
